...
class ExpenseForm(forms.ModelForm):
    long_term = forms.BooleanField(required=False)  # Fixed 'Boolen' to 'Boolean'
    ...
    def clean(self):
        ...
        if long_term:
            ...
            cleaned_data['long_term'] = True  # Corrected 'cleaned_date' to 'cleaned_data'
        else:
            cleaned_data['end_date'] = None  # Ensured correct assignment
            cleaned_data['interest_rate'] = None
        
        return cleaned_data  # Fixed indentation of return statement
